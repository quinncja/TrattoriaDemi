import { checkTableAvailability } from "./reservationChecker";
...
const {
  ...
  getNextSlot,
  getPrevSlot,
} = require("./reservationChecker"); // adjust the path and import according to your setup
...
describe("isWithinOneHourAndFifteen", () => {
  it("should check if a given time is within a 1-hour window of the specified time", () => {
    expect(isWithinOneHourAndFifteen("10:00", "10:15")).toBeTruthy();
    expect(isWithinOneHourAndFifteen("10:00", "11:00")).toBeTruthy();
    expect(isWithinOneHourAndFifteen("10:00", "11:16")).toBeFalsy();
    expect(isWithinOneHourAndFifteen("10:30", "11:00")).toBeTruthy();
    expect(isWithinOneHourAndFifteen("10:30", "11:30")).toBeTruthy();
  });
});
